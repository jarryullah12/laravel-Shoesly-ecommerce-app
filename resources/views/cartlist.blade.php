...
<html lang="en">
  ...
  <!-- header section end -->
    ...
    <div class="collection_text">Cart List</div>
                    ...
                    <div class="col-sm-10" >
                      <div class="trending-wrapper" >
                          ...
                          <div class="">
                            ...
                            <div class="row search-item cart-list-devider">
                              <div class="col-sm-3" >
                                  <a href="detail/{{$item->id}}">
                                      <img class="trending-img" src="{{ asset('storage/images/1/' . $item->gallery ) }}" style="width:210px;" >
                                      </a>
                              </div>
                              <div class="col-sm-6">
                                        <div class="">
                            ...
                            <div>
                                <a style="color: white" href="/removecart/{{$item->cart_id}}" class="btn btn-warning" >Remove From Cart</a>
                            </div>
                          @endforeach
